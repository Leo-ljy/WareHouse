...
public class BasicItemViewV extends FrameLayout {
	...
	private void readAttrs(Context context, AttributeSet attrs) {
		if (null != attrs) {
			...
			if (a.hasValue(R.styleable.SettingViewItem_setting_view_item_arrow)) {
				Drawable drawable = a.getDrawable(R.styleable.SettingViewItem_setting_view_item_arrow);
				if (null != drawable) {
			...
			if (a.hasValue(R.styleable.SettingViewItem_setting_view_item_subTitleSize)) {
				int textSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX, a.getDimensionPixelSize(R.styleable.SettingViewItem_setting_view_item_subTitleSize, 14), getResources().getDisplayMetrics());
			...
			if (a.hasValue(R.styleable.SettingViewItem_setting_view_item_titleSize)) {
				int textSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX, a.getDimensionPixelSize(R.styleable.SettingViewItem_setting_view_item_titleSize, 16), getResources().getDisplayMetrics());
