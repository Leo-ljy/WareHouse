package com.hzmy.zm.warehouse.third_party_libs.volley_gson_okhttp.manage;
...
public class VolleyManager
{
    ...
    private static class VolleyManagerHolder {
        private static final VolleyManager INSTANCE = new VolleyManager(AppContext.getInstance());
    }
