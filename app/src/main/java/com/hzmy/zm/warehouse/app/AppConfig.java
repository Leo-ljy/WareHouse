...
import com.hzmy.zm.warehouse.utils.StringUtilsTools;


@SuppressLint("NewApi")
public class AppConfig {private final static String APP_CONFIG = "config";
...
@SuppressLint("NewApi")
public final static String DEFAULT_SAVE_IMAGE_PATH = Environment.getExternalStorageDirectory()+ File.separator+ "HaoXuan"+ File.separator;
...
public long getExpiresIn() {
	return StringUtilsTools.toLong(get(CONF_EXPIRESIN));
}
