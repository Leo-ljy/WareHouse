package com.hzmy.zm.warehouse.third_party_libs.glide;
...
import com.hzmy.zm.warehouse.widgets.drop_down.GlideCircleTransform;
...
public class ImageManager
{
    ...
    // 加载网络图片
    public void loadUrlImage(String url, ImageView imageView, int placeholderImg) {
        Glide.with(mContext)
                .load(url)
    ...
    public void loadCircleImage(String url, ImageView imageView, int placeholderImg) {
        Glide.with(mContext)
                .load(url)
                .placeholder(placeholderImg)
                .error(placeholderImg)
